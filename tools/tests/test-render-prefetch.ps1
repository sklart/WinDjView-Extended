...
Require-SourcePattern 'src\RenderThread.cpp' 'left\.nPage == right\.nPage' 'full render identity page comparison'
...
Require-SourcePattern 'src\RenderThread.cpp' 'windows\.readInfoPages\.find\(it->nPage\)' 'read-info cleanup cancellation on re-entry'
