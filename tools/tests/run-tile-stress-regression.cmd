...
if not exist "%CORPUS_ROOT%\cable_1973_100133.djvu" (
	echo Missing two-page real DjVu fixture in "%CORPUS_ROOT%". 1>&2
	exit /b 2
)
...
echo Tile stress using VS2022 MSVC !VCToolsVersion! with MFC and ATL.
msbuild src\WinDjView.Native.vcxproj /nologo /t:Build /m /p:Configuration=Release /p:Platform=x64
if errorlevel 1 exit /b %errorlevel%
set "TEST_BASENAME=tools\tests\tile_stress_regression-Release-x64-native"
