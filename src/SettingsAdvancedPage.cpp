	...
	: CPropertyPage(CSettingsAdvancedPage::IDD)
{
	...
	m_bOpenLastDocuments = theApp.GetAppSettings()->bOpenLastDocuments;
	m_bFindBookmarkTitle = theApp.GetAppSettings()->bFindBookmarkTitle;
	m_bDisablePositioning = theApp.GetAppSettings()->bDisablePositioning;
	m_bCustomZoomLevels = theApp.GetAppSettings()->bCustomZoomLevels;
	m_strCustomZoomList = theApp.GetAppSettings()->strCustomZoomList;
...
void CSettingsAdvancedPage::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_OPEN_LAST_DOCUMENTS, m_bOpenLastDocuments);
	DDX_Check(pDX, IDC_FIND_CONTENT_TITLE, m_bFindBookmarkTitle);
	DDX_Check(pDX, IDC_DISABLE_POSITIONING, m_bDisablePositioning);
	DDX_Check(pDX, IDC_CUSTOM_ZOOM_LEVELS, m_bCustomZoomLevels);
	DDX_Text(pDX, ID_CUSTOM_ZOOM_LIST, m_strCustomZoomList);
