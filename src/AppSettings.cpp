...
double CAppSettings::unitsPerInch[] = { 2.54, 25.4, 1.0, 1.0};
...
CAppSettings::CAppSettings()
{
	...
	bProgramSettingsIntoRegistry = true;
	bDocsSettingsIntoRegistry = true;
	bRestoreView = true;
	bOpenLastDocuments = false;
	bFindBookmarkTitle = true;
	bDisablePositioning = false;
	bCustomZoomLevels = false;
	strCustomZoomList = _T("10, 12.5, 25, 33.33, 50, 66.66, 75, 100, 125, 150, 200, 300, 400, 600, 800");
	//bCheckUpdates = false;
	nLastUpdateTime = 0;
