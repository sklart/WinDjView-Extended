...
// Dialog Data
	...
	BOOL m_bNoRegistry;
	BOOL m_bProgramSettingsIntoRegistry;
	BOOL m_bDocsSettingsIntoRegistry;
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedProgramSettingsIntoRegistry();
	afx_msg void OnBnClickedDocsSettingsIntoRegistry();
};
