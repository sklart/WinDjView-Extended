...
public:
	...
	void CloseAllMDIChilds();

	void ActivateDocument(CDocument* pDocument);
	void UpdateToolbars();

	virtual void OnUpdate(const Observable* source, const Message* message);
	void SetMessageTxt(UINT nID);
	void SetMessageTxt(LPCTSTR lpszText);

	bool m_bDontActivate;
	CString m_strOldMessageTxt;
...
protected:
	...
	afx_msg void OnUpdateRotatePages(CCmdUI* pCmdUI);
	...
	afx_msg void OnViewCropPages();
	afx_msg void OnUpdateViewCropPages(CCmdUI *pCmdUI);
	DECLARE_MESSAGE_MAP()
};
